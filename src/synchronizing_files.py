...
class SynchronizingFiles ():
    ...
    async def running_strategy (self, currency) -> float:
        ...
        symbol_index = f'{currency}_usd'
        my_path_index = system_tools.provide_path_for_file ('index',  symbol_index)  
        index_price = pickling.read_data(my_path_index) 
        ...
        for instrument in instruments_name:
            ...
            log.error('PERPETUAL' in instrument)
