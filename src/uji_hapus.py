...
my_trades_open = [
    ...
    {'trade_seq': 122500021, 'trade_id': 'ETH-166583001', 'timestamp': 1681263668158, 'tick_direction': 3, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 7.246e-05, 'price': 1890.25, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32825081507', 'mmp': False, 'matching_id': None, 'mark_price': 1890.11, 'liquidity': 'M', 'label': 'every1hoursShort-closed-1681263648421', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 1890.73, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'buy', 'api': True, 'amount': 10.0}
    ]
