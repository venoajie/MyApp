...
my_trades_open = [
    ...
    {'trade_seq': 122453526, 'trade_id': 'ETH-166526905', 'timestamp': 1681205341061, 'tick_direction': 1, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 0.0, 'price': 1916.15, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32813880850', 'mmp': False, 'matching_id': None, 'mark_price': 1916.21, 'liquidity': 'M', 'label': 'hedgingSpot-open-1681205341061', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 1916.25, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'sell', 'api': True, 'amount': 72.0}]
