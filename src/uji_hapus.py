...
my_trades_open =[
    {'trade_seq': 122931300, 'trade_id': 'ETH-167116030', 'timestamp': 1681519153211, 'tick_direction': 0, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 0.0, 'price': 2092.25, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32885652532', 'mmp': False, 'matching_id': None, 'mark_price': 2092.46, 'liquidity': 'M', 'label': 'hedgingSpot-open-1681519153211', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 2092.69, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'sell', 'api': False, 'amount': 81.0}
    ]
