...
my_trades_open = [
    ...
    {'trade_seq': 122668128, 'trade_id': 'ETH-166788115', 'timestamp': 1681379087335, 'tick_direction': 0, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 0.0, 'price': 1982.85, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32850806120', 'mmp': False, 'matching_id': None, 'mark_price': 1982.48, 'liquidity': 'M', 'label': 'hedgingSpot-open-1681379086467', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 1981.27, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'sell', 'api': True, 'amount': 1.0}, 
    {'trade_seq': 122668132, 'trade_id': 'ETH-166788122', 'timestamp': 1681379091803, 'tick_direction': 1, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 0.0, 'price': 1982.9, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32850806898', 'mmp': False, 'matching_id': None, 'mark_price': 1982.71, 'liquidity': 'M', 'label': 'hedgingSpot-open-1681379088168', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 1981.46, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'sell', 'api': True, 'amount': 1.0}, 
