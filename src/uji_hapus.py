...
my_trades_open = [
    ...
    {'trade_seq': 122453042, 'trade_id': 'ETH-166526244', 'timestamp': 1681204338458, 'tick_direction': 1, 'state': 'filled', 'self_trade': False, 'risk_reducing': False, 'reduce_only': False, 'profit_loss': 0.0, 'price': 1918.55, 'post_only': True, 'order_type': 'limit', 'order_id': 'ETH-32813955804', 'mmp': False, 'matching_id': None, 'mark_price': 1918.84, 'liquidity': 'M', 'label': 'hedgingSpot-closed-12345678', 'instrument_name': 'ETH-PERPETUAL', 'index_price': 1918.67, 'fee_currency': 'ETH', 'fee': 0.0, 'direction': 'buy', 'api': True, 'amount': 9.0}, 
