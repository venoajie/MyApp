...
def get_contextnow(mean_val, ranking):
    ...
    ibrankdf["power1"] = 100 * (
        (ibrankdf.ib_poc + ibrankdf.ib_vah + ibrankdf.ib_val + ibrankdf.ibvol_rise) / 4
    )
