    ...
    async def ws_manager(self) -> None:
        async with websockets.connect(
            ...
            for currency in currencies:
                ...
                file_name_positions = (f'{currency.lower()}-positions.pkl')
                my_path_instruments = system_tools.provide_path_for_file (file_name_instruments, "market_data", "deribit")
                my_path_position = system_tools.provide_path_for_file (file_name_positions, "portfolio", "deribit")
                ...
                try:
                    position =  pickling.read_data (my_path_position)
                except:
                    position =  await deribit_get.get_position(client_id, client_secret, endpoint_position, currency)
                ...
                for instrument in instruments_name:
                    ...
                    log.warning (instruments_with_rebates)
                    ...
                    portfolio = pickling.read_data(f'{currency.lower()}-portfolio.pkl')
