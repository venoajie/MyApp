                    ...
                    if message['method'] != 'heartbeat':
                        ...
                        if message_channel == f'user.orders.future.{currency.upper()}.raw':
                            ...
                            if order_state == 'open':
                                ...
                                item_in_open_orders_open_with_same_id =  [o for o in data_orders if o['order_id'] == order_id ] 
                                item_in_open_orders_open_with_diff_id =  [o for o in data_orders if o['order_id'] != order_id ] 
