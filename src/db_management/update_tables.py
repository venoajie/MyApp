...
def update_table_strategy_entries(strategyId, params) -> list:
    ...
    query_table = (
        """UPDATE strategy_entries SET orderDate =?, orderId =? WHERE strategyId = ?"""
    )
    ...
    params_result = {
        "info": {
            ...
            "postOnly": True,
            "ioc": False,
            "createdAt": "2022-11-03T06:55:23.875812+00:00",
            "future": "BTC-MOVE-WK-1125",
        },
        "id": "196667997628",
        "clientOrderId": None,
        "timestamp": 1667458523875,
        "datetime": "2022-11-03T06:55:23.875Z",
        "lastTradeTimestamp": None,
        "symbol": "BTC-MOVE-WK/USD:USD-221126",
        "type": "limit",
        "timeInForce": "PO",
        "postOnly": True,
        "reduceOnly": False,
