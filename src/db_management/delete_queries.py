...
def deleting_expired_instrument (instrument, table: str = 'strategy_entries')->list:
    ...
    try:
        ...
        formula.log_error('deleting instrument', f'deleting expired instrument {instrument}', error, 30)    
        
def deleting_items_based_on_strategyId (strategyId, table: str = 'strategy_entries')->list:
    ...
    try:
        ...
        telegram_bot_sendtext(info,'general_error') 
        formula.log_error('deleting instrument', f'deleting expired id {strategyId}', error, 30)    