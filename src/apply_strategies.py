...
class ApplyHedgingSpot:
    ...
    async def is_send_exit_or_additional_order_allowed(
        ...
        is_max_price_in_label = str_mod.get_strings_before_character(([o['label'] for o in open_trade if o['price']==max_price_as_per_label ][0]), "-", 0)
        log.info (is_max_price_in_label)
        if "hedgingSpot" in is_max_price_in_label:
