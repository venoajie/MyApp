...
def test_is_send_additional_order_allowed():
    ...
    strategy_attributes_long = [
        o for o in strategy_attributes_entry if "basicGridLong" in o["strategy"]
    ]
    ...
    selected_transaction = [
        {
            "trade_seq": 124846096,
            "trade_id": "ETH-169499233",
            "timestamp": 1683196536143,
            "tick_direction": 2,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            "reduce_only": False,
            "profit_loss": -2.08e-05,
            "price": 1915.9,
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-33232149026",
            "mmp": False,
            "matching_id": None,
            "mark_price": 1916.65,
            "liquidity": "M",
            "label": "basicGridLong-open-1683196535027",
    ...
    result = grid.is_send_additional_order_allowed(
        notional,
        ask_price,
        bid_price,
    ...
    strategy_attributes_short = [
        o for o in strategy_attributes_entry if "basicGridShort" in o["strategy"]
    ]
    ...
    selected_transaction = [
        {
            "trade_seq": 124728213,
            "trade_id": "ETH-169356431",
            "timestamp": 1683115014598,
            "tick_direction": 3,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-33212664365",
            "mmp": False,
            "matching_id": None,
            "mark_price": 1860.87,
            "liquidity": "M",
            "label": "basicGridShort-open-1683115008542",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 1860.74,
            "fee_currency": "ETH",
            "fee": 0.0,
