...
def test_get_nearest_tick  ():
    ...
    assert number_modification.get_nearest_tick (price1, 
                                                 tick) == 1550.05
    
    assert number_modification.get_nearest_tick (price2,
                                                 tick) == 1550.5
    
    assert number_modification.get_nearest_tick (price3, 
                                                 tick) == 1550.45