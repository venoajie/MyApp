...
my_orders_all = [
    {
        ...
        "order_type": "limit",
        "order_state": "open",
        "order_id": "ETH-3097385800",
        "mmp": False,
        "max_show": 108.0,
        "last_update_timestamp": 1671093368895,
        "label": "hedgingSpot-open-1671093365868",
        "is_liquidation": False,
        "instrument_name": "ETH-23DEC22",
        "filled_amount": 0.0,
        "direction": "sell",
        "creation_timestamp": 1671093368895,
        "commission": 0.0,
        "average_price": 0.0,
        "api": True,
        "amount": 108.0,
    },
    {
        ...
        "order_type": "limit",
        "order_state": "open",
        "order_id": "ETH-3097383152",
        "mmp": False,
        "max_show": 5.0,
        "last_update_timestamp": 1671093338010,
        "label": "",
        "is_liquidation": False,
        "instrument_name": "ETH-PERPETUAL",
        "filled_amount": 0.0,
        "direction": "sell",
        "creation_timestamp": 1671093338010,
        "commission": 0.0,
        "average_price": 0.0,
        "api": False,
        "amount": 5.0,
    },
    {
        ...
        "order_type": "limit",
        "order_state": "open",
        "order_id": "ETH-3097524136",
        "mmp": False,
        "max_show": 108.0,
        "last_update_timestamp": 1671095068918,
        "label": "hedgingSpot-open-1671095066375",
        "is_liquidation": False,
        "instrument_name": "ETH-23DEC22",
        "filled_amount": 0.0,
        "direction": "sell",
        "creation_timestamp": 1671095068918,
        "commission": 0.0,
        "average_price": 0.0,
        "api": True,
        "amount": 108.0,
...
def test_my_orders_api_basedOn_label():
    assert (
        open_orders.open_orders_api_basedOn_label("hedgingSpot")
        == my_orders_with_api_true
    )
...
def test_my_orders_api_last_update_timestamp():
    assert open_orders.open_orders_api_last_update_timestamps() == [
        1671093368895,
        1671095068918,
    ]
...
def test_combine_open_orders_based_on_id():
    ...
    order_id = 2
    expected_result = {
        "item_with_same_id": [{"order_id": 2}],
        "item_with_diff_id": [{"order_id": 1}, {"order_id": 3}],
    }
    assert (
        open_orders.combine_open_orders_based_on_id(open_orders_open, order_id)
        == expected_result
    )
...
def tst_determine_order_size_and_side_for_outstanding_transactions():
    ...
    open_trade = [
        {
            "trade_seq": 118854184,
            "trade_id": "ETH-161815173",
            "timestamp": 1678158321841,
            "tick_direction": 1,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-32091091431",
            "mmp": False,
            "matching_id": None,
            "mark_price": 1582.82,
            "liquidity": "M",
            "label": "supplyDemandShort60A-open-1678158310813",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 1582.49,
            "fee_currency": "ETH",
            "fee": 0.0,
        ...
        },
        {
            ...
            "mark_price": 1635.17,
            "liquidity": "M",
            "label": "supplyDemandLong60A-open-1677473096934",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 1635.36,
            "fee_currency": "ETH",
            "fee": 0.0,
...
def tst_is_open_trade_has_exit_order():
    ...
    open_trade2 = [
        ...
        {
            "trade_seq": 118988617,
            "trade_id": "ETH-161978397",
            "timestamp": 1678317993146,
            "tick_direction": 3,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-32123173645",
            "mmp": False,
            "matching_id": None,
            "mark_price": 1534.75,
            "liquidity": "M",
            "label": "supplyDemandShort60A-closed-1678158310813",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 1535.05,
            "fee_currency": "ETH",
            "fee": 0.0,
    ...
    strategies = string_modification.remove_redundant_elements(
        [
            string_modification.get_strings_before_character(o["label"])
            for o in open_trade
        ]
    )
    strategies2 = string_modification.remove_redundant_elements(
        [
            string_modification.get_strings_before_character(o["label"])
            for o in open_trade2
        ]
    )
    ...
    for strategy in strategies2:
        if strategy == "supplyDemandShort60A-1678158310813":
            ...
            assert (
                open_orders2.is_open_trade_has_exit_order_sl(open_trade2, strategy)[
                    "is_exit_order_ok"
                ]
                == False
            )
            assert (
                open_orders2.is_open_trade_has_exit_order_sl(open_trade2, strategy)[
                    "current_order_len_exceeding_minimum"
                ]
                == False
            )
            assert (
