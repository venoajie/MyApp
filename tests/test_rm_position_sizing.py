...
def test_sizing_for_perpetual_grid():
    ...
    daily_turn_over = position_sizing.daily_turn_over(
        pct_daily_profit_target, pct_profit_per_transaction
    )
    assert daily_turn_over == 6

    hourly_sizing = position_sizing.hourly_sizing_for_perpetual_grid(
    ...
    qties_order_and_time_delay = position_sizing.qty_order_and_time_delay(
        notional, pct_daily_profit_target, pct_profit_per_transaction
    )
