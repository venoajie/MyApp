...
def test_get_strings_before_character():
    assert (
        string_modification.get_strings_before_character(
            "hedgingSpot-open-1671189554374", "-", 0
        )
        == "hedgingSpot"
    )
    assert (
        string_modification.get_strings_before_character(
            "supplyDemandLong60B-closed-1677903684425", "-", 0
        )
        == "supplyDemandLong60B"
    )
    assert (
        string_modification.get_strings_before_character(
            "supplyDemandShort60-closed-1677473096", "-", 0
        )
        == "supplyDemandShort60"
    )
    assert (
    ...
    assert (
        string_modification.get_strings_before_character(
            "supplyDemandShort60-closed-1677473096", "-", 2
        )
        == "1677473096"
    )
    assert (
        string_modification.get_strings_before_character(
            "supplyDemandShort60-closed-1677473096", "-", [0, 1]
        )
        == "supplyDemandShort60-closed"
    )
    assert (
        string_modification.get_strings_before_character(
            "supplyDemandShort60-closed-1677473096"
        )
        == "supplyDemandShort60-1677473096"
    )
