...
my_trades_open = {
    "all": [
        {
            "id": 1,
            "data": '{"trade_seq":122628217,"trade_id":"ETH-166736294","timestamp":1681359527286,"tick_direction":1,"state":"filled","self_trade":false,"risk_reducing":false,"reduce_only":false,"profit_loss":0.0,"price":1940.7,"post_only":true,"order_type":"limit","order_id":"ETH-32845591518","mmp":false,"matching_id":null,"mark_price":1940.67,"liquidity":"M","label":"hedgingSpot-open-1681359527286","instrument_name":"ETH-PERPETUAL","index_price":1940.06,"fee_currency":"ETH","fee":0.0,"direction":"sell","api":false,"amount":70.0}',
            "trade_seq": 122628217,
            "order_id": "ETH-32845591518",
            "label_main": "hedgingSpot-open-1681359527286",
            "amount_dir": -70.0,
        },
        {
            "id": 60,
            "data": '{"trade_seq":122793232,"trade_id":"ETH-166947107","timestamp":1681447691857,"tick_direction":2,"state":"filled","self_trade":false,"risk_reducing":false,"reduce_only":false,"profit_loss":-9.23e-05,"price":2116.85,"post_only":true,"order_type":"limit","order_id":"ETH-32867483737","mmp":false,"matching_id":null,"mark_price":2117.09,"liquidity":"M","label":"every4hoursLong-open-1681447421981","instrument_name":"ETH-PERPETUAL","index_price":2117.01,"fee_currency":"ETH","fee":0.0,"direction":"buy","api":true,"amount":3.0}',
            "trade_seq": 122793232,
            "order_id": "ETH-32867483737",
            "label_main": "every4hoursLong-open-1681447421981",
            "amount_dir": 3.0,
        },
    ],
    "list_data_only": [
        {
            "trade_seq": 122628217,
            "trade_id": "ETH-166736294",
            "timestamp": 1681359527286,
            "tick_direction": 1,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "mark_price": 1940.67,
            "liquidity": "M",
            "label": "hedgingSpot-open-1681359527286",
        ...
        {
            "trade_seq": 122793232,
            "trade_id": "ETH-166947107",
            "timestamp": 1681447691857,
            "tick_direction": 2,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            "reduce_only": False,
            "profit_loss": -9.23e-05,
            "price": 2116.85,
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-32867483737",
            ...
            "mark_price": 2117.09,
            "liquidity": "M",
            "label": "every4hoursLong-open-1681447421981",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 2117.01,
            "fee_currency": "ETH",
            "fee": 0.0,
...
orders_from_sqlite = {
    "all": [
        ...
        },
        {
            ...
            "order_id": "ETH-32892551169",
            "label_main": "every5mtestLong-open-1681568392126",
            "amount_dir": 1.0,
        },
    ],
    "list_data_only": [
        {
            ...
            "mmp": False,
            "max_show": 1.0,
            "last_update_timestamp": 1681568392117,
            "label": "every5mtestLong-open-1681568392078",
            "is_liquidation": False,
            "instrument_name": "ETH-PERPETUAL",
            "filled_amount": 0.0,
            "direction": "buy",
            "creation_timestamp": 1681568392117,
            "commission": 0.0,
            "average_price": 0.0,
            "api": True,
            "amount": 1.0,
        },
        {
            ...
            "mmp": False,
            "max_show": 1.0,
            "last_update_timestamp": 1681568392163,
            "label": "every5mtestLong-open-1681568392126",
            "is_liquidation": False,
            "instrument_name": "ETH-PERPETUAL",
            "filled_amount": 0.0,
            "direction": "buy",
            "creation_timestamp": 1681568392163,
            "commission": 0.0,
            "average_price": 0.0,
            "api": True,
            "amount": 1.0,
...
orders_from_sqlite2 = {
    "all": [
        ...
        },
        {
            ...
            "order_id": "ETH-32990829565",
            "label_main": "every1hoursShort-open-1682058484564",
            "amount_dir": 4.0,
        },
    ],
    "list_data_only": [
        {
            ...
            "mmp": False,
            "max_show": 4.0,
            "last_update_timestamp": 1682058485602,
            "label": "every1hoursShort-open-1682058485562",
            "is_liquidation": False,
            "instrument_name": "ETH-PERPETUAL",
            "filled_amount": 0.0,
            "direction": "sell",
            "creation_timestamp": 1682058485602,
            "commission": 0.0,
            "average_price": 0.0,
            "api": True,
            "amount": 4.0,
        },
        {
            ...
            "mmp": False,
            "max_show": 4.0,
            "last_update_timestamp": 1682058484601,
            "label": "every1hoursShort-open-1682058484564",
            "is_liquidation": False,
            "instrument_name": "ETH-PERPETUAL",
            "filled_amount": 0.0,
            "direction": "sell",
            "creation_timestamp": 1682058484601,
            "commission": 0.0,
            "average_price": 0.0,
            "api": True,
            "amount": 4.0,
...
grids = grid.GridPerpetual(my_trades_open, orders_from_sqlite)
grids2 = grid.GridPerpetual(my_trades_open, orders_from_sqlite2)
strategy_from_config_none = None

grid_str_none = grid.GridPerpetual(my_trades_open, orders_from_sqlite)
# active_trade_item_none = None
grid_act_trd_none = grid.GridPerpetual(my_trades_open, orders_from_sqlite)
...
async def test_get_params_orders_closed():
    ...
    active_trade_item = [
        {
            "trade_seq": 123753040,
            "trade_id": "ETH-168130917",
            "timestamp": 1682245158199,
            "tick_direction": 0,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-33022684688",
            "mmp": False,
            "matching_id": None,
            "mark_price": 1869.24,
            "liquidity": "M",
            "label": "every5mtestShort-open-1682245078601",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 1869.24,
            "fee_currency": "ETH",
            "fee": 0.0,
    ...
    result = await grids.get_params_orders_closed(
        active_trade_item, current_net_position_size, best_bid_prc, best_ask_prc
    )
    assert result == {
        "instrument": "ETH-PERPETUAL",
        "label": "every5mtestShort-closed-1682245078601",
        "side": "buy",
        "size": 1.0,
        "type": "limit",
        "price_threshold": 1865.4117,
        "len_order_limit": 0,
        "entry_price": 1869.24,
        "order_buy": False,
        "order_sell": False,
    ...
    assert result == {
        ...
        "size": 1.0,
        "type": "limit",
        "price_threshold": 1861.6734000000001,
        "len_order_limit": 0,
        "entry_price": 1869.24,
        "order_buy": False,
        "order_sell": False,
    ...
    current_net_position_size = -16
    result = await grids.get_params_orders_closed(
        active_trade_item, current_net_position_size, best_bid_prc, best_ask_prc
    )
    assert result == {
        "instrument": "ETH-PERPETUAL",
        "label": "every4hoursLong-closed-1681447421981",
        "side": "sell",
        "size": 3.0,
        "type": "limit",
        "price_threshold": 2159.187,
        "len_order_limit": 0,
        "entry_price": 2160,
        "order_buy": False,
        "order_sell": True,
    ...
    active_trade_item = [
        {
            "trade_seq": 122993401,
            "trade_id": "ETH-167190562",
            "timestamp": 1681598206591,
            "tick_direction": 3,
            "state": "filled",
            "self_trade": False,
            "risk_reducing": False,
            ...
            "post_only": True,
            "order_type": "limit",
            "order_id": "ETH-32897249916",
            "mmp": False,
            "matching_id": None,
            "mark_price": 2095.88,
            "liquidity": "M",
            "label": "every4hoursShort-open-1681598206591",
            "instrument_name": "ETH-PERPETUAL",
            "index_price": 2095.65,
            "fee_currency": "ETH",
            "fee": 0.0,
    ...
    assert result == {
        "instrument": "ETH-PERPETUAL",
        "label": "every4hoursShort-closed-1681598206591",
        "side": "buy",
        "size": 3.0,
        "type": "limit",
        "price_threshold": 2074.9410000000003,
        "len_order_limit": 0,
        "entry_price": 2095,
        "order_buy": False,
        "order_sell": False,
...
@pytest.mark.asyncio
async def test_adjusting_size_and_time():
    current_side = "buy"
    current_proposed_size = 1
    current_net_position_size = -18
    result = await grids.adjusting_size_open_order(
        current_side, current_proposed_size, current_net_position_size
    )
    assert result == 4

    result = await grids.adjusting_tp_closed_order(
        current_side, current_proposed_size, current_net_position_size
    )
    assert result == 2
