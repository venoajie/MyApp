...
def test_convert_time_to_unix():
    ...
    assert (
        time_modification.convert_time_to_unix(test_data_transaction_time1)
        == 1671032009858
    )
    # test result one minute = 60000
    assert (
        time_modification.convert_time_to_unix(test_data_transaction_time2)
        - time_modification.convert_time_to_unix(test_data_transaction_time1)
        == 60000
    )
    # test result one second = 1000
    assert (
        time_modification.convert_time_to_unix(test_data_transaction_time3)
        - time_modification.convert_time_to_unix(test_data_transaction_time2)
        == 1000
    )
...
def test_translate_current_local_date_time_to_utc():
    ...
    expected_utc_date_time = str(
        local_date_time.astimezone().astimezone(timezone.utc).replace(tzinfo=None)
    )
    actual_utc_date_time = str(
        time_modification.translate_current_local_date_time_to_utc()
    )
...
def test_time_delta_between_two_times():
    ...
    assert (
        time_modification.time_delta_between_two_times(
...
def test_check_alarm_clock():
    ...
    alarm = time_modification.check_alarm_clock(
        triggerHour, triggerMinute, isTrigger=False
    )
